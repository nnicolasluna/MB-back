...
import { MonitoringWater } from '@prisma/client';
import { Exclude } from 'class-transformer';

export class MonitoringWaterEntity implements MonitoringWater {
	...
	constructor(partial: Partial<MonitoringWaterEntity>) {
