...
import { MonitoringSoilDegradation } from '@prisma/client';
import { Exclude } from 'class-transformer';

export class MonitoringSoilDegradationEntity implements MonitoringSoilDegradation {
	...
	constructor(partial: Partial<MonitoringSoilDegradation>) {
