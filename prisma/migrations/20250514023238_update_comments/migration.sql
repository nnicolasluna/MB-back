...
-- sitios_arqueologicos comments
COMMENT ON TABLE "sitios_arqueologicos" IS 'Tabla Sitios Arqueológicos';
COMMENT ON COLUMN "sitios_arqueologicos"."id" IS 'Id único del sitio';
COMMENT ON COLUMN "sitios_arqueologicos"."nombre" IS 'Nombre del sitio';
COMMENT ON COLUMN "sitios_arqueologicos"."cobertura" IS 'Nombre de la cobertura';
COMMENT ON COLUMN "sitios_arqueologicos"."estilo" IS 'Nombre del estilo';
...
COMMENT ON COLUMN "recursos_cartograficos"."url_image" IS 'Imagen raster';
COMMENT ON COLUMN "recursos_cartograficos"."srs_image" IS 'SRS raster';
COMMENT ON COLUMN "recursos_cartograficos"."name_image" IS 'Raster name in db';
COMMENT ON COLUMN "recursos_cartograficos"."import_id" IS 'Id de importación raster geoserver';
COMMENT ON COLUMN "recursos_cartograficos"."bbox_image" IS 'Boundingbox del raster';
...
-- alertas_suelo comments
COMMENT ON TABLE "alertas_suelo" IS 'Tabla de alertas de suelo';
COMMENT ON COLUMN "alertas_suelo"."id" IS 'Id único del registro';
COMMENT ON COLUMN "alertas_suelo"."nombre" IS 'Nombre';
COMMENT ON COLUMN "alertas_suelo"."descripcion" IS 'Descripción';
COMMENT ON COLUMN "alertas_suelo"."fecha_contenido" IS 'Fecha de del mapa';
COMMENT ON COLUMN "alertas_suelo"."estado_contenido" IS 'Estado Activo/Inactivo';
COMMENT ON COLUMN "alertas_suelo"."bbox" IS 'Boundingbox del mapa';
COMMENT ON COLUMN "alertas_suelo"."capa" IS 'Nombre de la tabla del mapa en el schema cartographic';
COMMENT ON COLUMN "alertas_suelo"."nombre_estilo" IS 'Nombre del estilo asociado al mapa';
COMMENT ON COLUMN "alertas_suelo"."aud_usuario_crea" IS 'Id del usuario que creo el registro';
COMMENT ON COLUMN "alertas_suelo"."aud_fecha_crea" IS 'Fecha de creación del registro';
COMMENT ON COLUMN "alertas_suelo"."aud_usuario_modifica" IS 'Id del usuario que actualizó el registro';
COMMENT ON COLUMN "alertas_suelo"."aud_fecha_modifica" IS 'Fecha de actualización del registro';
COMMENT ON COLUMN "alertas_suelo"."aud_usuario_elimina" IS 'Id del usuario que eliminó el registro';
COMMENT ON COLUMN "alertas_suelo"."aud_fecha_elimina" IS 'Fecha de eliminación del registro';
COMMENT ON COLUMN "alertas_suelo"."state" IS 'Estado del registro true = eliminado';
COMMENT ON COLUMN "alertas_suelo"."codigo" IS 'Código único del registro';
