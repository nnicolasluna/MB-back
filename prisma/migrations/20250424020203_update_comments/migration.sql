...
COMMENT ON TABLE "monitoreo_incendios" IS 'Tabla de monitoreo de cuerpos de agua';
...
COMMENT ON COLUMN "monitoreo_incendios"."area" IS 'Area en Hectáreas';
...
COMMENT ON COLUMN "monitoreo_agua"."area" IS 'Area en Hectáreas';
